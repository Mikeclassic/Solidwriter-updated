...
import { Check, Bot, Zap, Shield, Sparkles, PenTool, LayoutTemplate, Megaphone, Share2, Globe, Star } from "lucide-react";
  ...
  return (
    <div className="flex min-h-screen flex-col font-sans bg-background text-foreground overflow-x-hidden">
      ...
      <section className="relative pt-20 pb-32 px-6 text-center overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-8 duration-700">
          ...
          <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight leading-[1.1]">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-blue-400">Actually Converts.</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 pt-4">
            <SmartStartButton />
            <a href="#how-it-works">
                <button className="px-8 py-4 rounded-full text-lg font-bold border border-border bg-card hover:bg-secondary transition-all flex items-center justify-center gap-2">
                    See How It Works
                </button>
            </a>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
                ...
                <div className="bg-background p-8 rounded-3xl border shadow-sm hover:shadow-md transition-all hover:-translate-y-1 group">
                    ...
                    <h3 className="text-2xl font-bold mb-3">Long-Form Blog Wizard</h3>
                ...
                {/* Feature 3 */}
                <div className="bg-background p-8 rounded-3xl border shadow-sm hover:shadow-md transition-all hover:-translate-y-1 group">
                    <div className="w-14 h-14 bg-orange-50 dark:bg-orange-900/20 rounded-2xl flex items-center justify-center mb-6 text-orange-600 dark:text-orange-400 group-hover:scale-110 transition-transform">
                ...
                {/* Feature 4 */}
                <div className="bg-background p-8 rounded-3xl border shadow-sm hover:shadow-md transition-all hover:-translate-y-1 group md:col-span-2">
                    <div className="flex flex-col md:flex-row gap-8 items-center">
                        <div className="flex-1 space-y-4">
                            <div className="w-14 h-14 bg-green-50 dark:bg-green-900/20 rounded-2xl flex items-center justify-center mb-2 text-green-600 dark:text-green-400 group-hover:scale-110 transition-transform">
                                <Zap className="h-7 w-7"/>
                            </div>
                            <h3 className="text-2xl font-bold">Powered by Moonshot Reasoning</h3>
                            <p className="text-muted-foreground">We don't use generic models. We use advanced reasoning chains that "think" before they write, ensuring factual accuracy and logical flow.</p>
                        </div>
                        <div className="flex-1 bg-secondary/50 rounded-xl p-6 w-full">
                ...
                {/* Feature 5 */}
                <div className="bg-background p-8 rounded-3xl border shadow-sm hover:shadow-md transition-all hover:-translate-y-1 group">
                    <div className="w-14 h-14 bg-red-50 dark:bg-red-900/20 rounded-2xl flex items-center justify-center mb-6 text-red-600 dark:text-red-400 group-hover:scale-110 transition-transform">
      ...
      <section id="pricing" className="py-24 px-6 bg-secondary/20">
        <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
                ...
                <p className="text-xl text-muted-foreground">Start your 7-day free trial today. No credit card required.</p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
                 {[
                     ...
                     <div key={plan.name} className={`relative bg-card p-8 rounded-3xl border shadow-sm transition-all hover:border-primary ${plan.popular ? 'border-primary ring-1 ring-primary shadow-xl scale-105 z-10' : ''}`}>
                        ...
                        <p className="text-sm text-muted-foreground mb-8 pb-8 border-b">Best for creators and small teams scaling content.</p>
                        
                        <ul className="space-y-4 mb-8">
                            <li className="flex gap-3 text-sm items-center"><div className="p-1 rounded-full bg-green-100 text-green-600"><Check className="h-3 w-3"/></div> {plan.words} Words / month</li>
                            <li className="flex gap-3 text-sm items-center"><div className="p-1 rounded-full bg-green-100 text-green-600"><Check className="h-3 w-3"/></div> Access to All Wizards</li>
                            <li className="flex gap-3 text-sm items-center"><div className="p-1 rounded-full bg-green-100 text-green-600"><Check className="h-3 w-3"/></div> 30+ Languages</li>
                            <li className="flex gap-3 text-sm items-center"><div className="p-1 rounded-full bg-green-100 text-green-600"><Check className="h-3 w-3"/></div> Priority Support</li>
                        </ul>
                        
                        <Link href="/pricing" className="block">
                            <button className={`w-full py-4 rounded-xl font-bold transition-all ${plan.popular ? 'bg-primary text-primary-foreground hover:shadow-lg' : 'bg-secondary hover:bg-secondary/80'}`}>
                                Start 7-Day Free Trial
                            </button>
                        </Link>
                        <p className="text-center text-xs text-muted-foreground mt-4">No credit card required</p>
                     </div>
                 ))}
            </div>
        </div>
      ...
      <section className="py-24 px-6 text-center">
        <div className="max-w-4xl mx-auto bg-primary/5 rounded-3xl p-12 border border-primary/10">
